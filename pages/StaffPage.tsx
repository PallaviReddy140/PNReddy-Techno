...
const StaffPage: React.FC<StaffPageProps> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['staff', 'specialized', 'committees', 'awards'];
      ...
      <section className="bg-blue-900 pt-32 pb-24 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-4 animate-fadeIn">School Staff</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="lg:w-72 shrink-0">
            <div className="lg:sticky lg:top-32 space-y-2">
              ...
              {[
                { id: 'staff', label: 'School Staff', icon: '🎓' },
          ...
          <div className="flex-grow space-y-24 pb-20">
            ...
            <section id="staff">
              <div className="mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold text-blue-900 mb-4">School Leadership Staff</h2>
            ...
            <section id="specialized">
              <div className="mb-10">
                <h2 className="text-3xl md:text-4xl font-extrabold text-blue-900 mb-4">Specialized Heads</h2>
              ...
              <div className="grid lg:grid-cols-2 gap-10">
                <div className="space-y-6">
                  <h3 className="text-xl font-bold text-blue-900 flex items-center gap-2">
                    <span className="text-blue-600">📖</span> Literary Heads
                  </h3>
                ...
                <div className="space-y-6">
                  <h3 className="text-xl font-bold text-blue-900 flex items-center gap-2">
                    <span className="text-pink-600">🎨</span> Cultural Heads
                  </h3>
                  <div className="grid gap-4">
